import { createKey, getKey, deleteKey, listAllKeys } from '../DAO/KeysDAO.js'; // Ajuste o caminho de importação conforme necessário
...
export const deleteChave = async (req, res) => {
    try {
        const numberOfDestroyedRows = await deleteKey(req.params.id);
